...
<head>
<meta charset="UTF-8">
<title>Восстановление аккаунта - Project Blackout|OZ-Network</title>
...
<div id="container">
	...
	<!-- RESTORE_PAGE -->
	<div id="page_bg"></div>
	<div id="restore_page_bg"></div>
	<input type="text" id="email_restore" name="Editbox1" value="" placeholder="&#1042;&#1072;&#1096; E-Mail">
	<div id="account_restore">
		<span style="color:#FFFFFF;font-family:Arial;font-size:16px;">Восстановление аккаунта</span>
	</div>
	<div id="email_info">
		<span style="color:#A9A9A9;font-family:Arial;font-size:13px;">Электронная почта, к которой привязан аккаунт</span>
	</div>
	<a href="http://pb.oz-network.ru/save.php?">
		<div id="restore_button"></div>
	</a>
	<!-- END RESTORE_PAGE -->
	<!-- LOGIN_PANEL -->
	<div id="login_bg"></div>
	...
	<a href="http://api.oz-network.ru/pb/getLogin?login=">
